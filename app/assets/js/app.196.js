...
// UNUSED EXPORTS: CacheProvider, ClassNames, createElement, css, keyframes
...
var utils_browser_esm = __webpack_require__(8087);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "vR": () => (/* binding */ LocationProvider),
  "F0": () => (/* binding */ Router),
  "fi": () => (/* reexport */ createHistory),
  "Xv": () => (/* reexport */ createMemorySource)
});

// UNUSED EXPORTS: Link, Location, Match, Redirect, ServerLocation, globalHistory, isRedirect, matchPath, navigate, redirectTo, useLocation, useMatch, useNavigate, useParams
...
var lib = __webpack_require__(2404);
...
var core_browser_esm = __webpack_require__(8152);
...
const package_namespaceObject = {"i8":"10.1.1"};
...
var jsx$1 = function (type, props) {
  ...
  return core_browser_esm/* jsx.apply */.tZ.apply(undefined, [type, parseProps(props) ].concat( children));
};
...
var BaseProvider = function (ref) {
  ...
  return jsx$1(core_browser_esm/* ThemeContext.Provider */.Ni.Provider, {
  value: context.theme
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "Zo": () => (/* binding */ MDXProvider$1),
  "RQ": () => (/* binding */ Styled)
});

// UNUSED EXPORTS: components, themed

// EXTERNAL MODULE: ./node_modules/@theme-ui/core/dist/index.esm.js + 1 modules
var index_esm = __webpack_require__(5770);
// EXTERNAL MODULE: ./node_modules/@theme-ui/css/dist/index.esm.js
...
;// CONCATENATED MODULE: ./node_modules/@theme-ui/mdx/node_modules/@emotion/styled/dist/styled.browser.esm.js
...
;// CONCATENATED MODULE: ./node_modules/@theme-ui/mdx/dist/index.esm.js
...
var index_esm_tags = ['p', 'b', 'i', 'a', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'img', 'pre', 'code', 'ol', 'ul', 'li', 'blockquote', 'hr', 'em', 'table', 'tr', 'th', 'td', 'em', 'strong', 'del', // mdx
...
var themed = function (key) { return function (props) { return (0,dist_index_esm/* css */.i)((0,dist_index_esm/* get */.U)(props.theme, ("styles." + key)))(props.theme); }; };
var Styled = styled_browser_esm('div')(themed('div'));
var components = {};
index_esm_tags.forEach(function (tag) {
  components[tag] = styled_browser_esm(alias(tag))(themed(tag));
...
var createComponents = function (comps) {
  ...
  Object.keys(comps).forEach(function (key) {
    next[key] = styled_browser_esm(comps[key])(themed(key));
  });
  return next;
};
...
var MDXProvider$1 = function (ref) {
  ...
  return (0,index_esm/* jsx */.tZ)(MDXProvider, {
...
// EXTERNAL MODULE: ./node_modules/@emotion/core/dist/core.browser.esm.js + 7 modules
var core_browser_esm = __webpack_require__(8152);
;// CONCATENATED MODULE: ./node_modules/@theme-ui/color-modes/dist/index.esm.js
...
var applyColorMode = function (theme, mode) {
  ...
  var modes = (0,dist_index_esm/* get */.U)(theme, 'colors.modes', {});
  return index_esm/* merge.all */.TS.all({}, theme, {
    colors: (0,dist_index_esm/* get */.U)(modes, mode, {})
  });
};

var BodyStyles = function () { return (0,index_esm/* jsx */.tZ)(core_browser_esm/* Global */.xB, {
...
var ColorModeProvider = function (ref) {
  ...
  var outer = (0,index_esm/* useThemeUI */.B7)();
  ...
  return (0,index_esm/* jsx */.tZ)(core_browser_esm/* ThemeContext.Provider */.Ni.Provider, {
    value: emotionTheme
  }, (0,index_esm/* jsx */.tZ)(index_esm/* Context.Provider */._y.Provider, {
    value: context
  }, (0,index_esm/* jsx */.tZ)(BodyStyles, {
    key: 'color-mode'
  }), children));
};
...
;// CONCATENATED MODULE: ./node_modules/@theme-ui/theme-provider/dist/index.esm.js
...
var index_esm_BodyStyles = function () { return (0,index_esm/* jsx */.tZ)(core_browser_esm/* Global */.xB, {
...
var ThemeProvider$1 = function (ref) {
  ...
  if (typeof outer.setColorMode === 'function') {
    return (0,index_esm/* jsx */.tZ)(index_esm/* ThemeProvider */.f6, {
      theme: theme
    }, (0,index_esm/* jsx */.tZ)(mdx_dist_index_esm/* MDXProvider */.Zo, {
  ...
  return (0,index_esm/* jsx */.tZ)(index_esm/* ThemeProvider */.f6, {
    theme: theme
  }, (0,index_esm/* jsx */.tZ)(ColorModeProvider, null, (0,index_esm/* jsx */.tZ)(index_esm_BodyStyles), (0,index_esm/* jsx */.tZ)(mdx_dist_index_esm/* MDXProvider */.Zo, {
    components: components,
    children: children
  })));
};
...
var arraySpeciesCreate = __webpack_require__(6722);
...
var _gud = __webpack_require__(7815);
...
var _implementation = __webpack_require__(8966);
